...
Public Class Localization
    ...
    Public RestartTutorial As String = "Restart Tutorial"
    Public GuideImageTool As String = "Guide Image Tool"
    Public MoveUp As String = "Move Up"
    Public MoveDown As String = "Move Down"
    Public MoveLeft As String = "Move Left"
    Public MoveRight As String = "Move Right"
    Public GenerateLinear As String = "Generate Linear"
    Public GenerateMatrix As String = "Generate Matrix"
    Public GenerateLShape As String = "Generate L-Shape"
    Public GenerateUShape As String = "Generate U-Shape"
    Public GenerateRectangle As String = "Generate Rectangle"
    Public TutComponentDetails As String = "Here you can edit the component's name, vendor, product and type. These details are only for organizational purposes within SignalRGB."
    ...
    Public TutUcComponentControls As String = "You can move the editor with middle mouse button, zoom in and out with the scroll wheel, and select, place or edit LEDs with the left mouse button. Right clicking will open a context menu with more options and keyboard shortcuts for these actions are also available."
    Public CtrlDelete As String = "Delete - Remove last placed LED"
    Public CtrlDeleteHold As String = "Hold Delete - Remove all placed LEDs"
    Public CtrlLeft As String = "Left Arrow - Move selected/all LEDs left"
    Public CtrlRight As String = "Right Arrow - Move selected/all LEDs right"
    Public CtrlUp As String = "Up Arrow - Move selected/all LEDs up"
    Public CtrlDown As String = "Down Arrow - Move selected/all LEDs down"
    Public CtrlCopy As String = "Ctrl + C - Copy selected LED(s)"
    Public CtrlPaste As String = "Ctrl + V - Paste copied LED(s) at mouse position"
    Public CtrlHide As String = "Ctrl + H - Show/Hide selected LEDs"
    Public CtrlMouse1 As String = "Left Mouse Button - Place or Select LEDs"
    Public CtrlMouse2 As String = "Right Mouse Button - Open Context Menu"
    Public CtrlMouse3 As String = "Middle Mouse Button - Move Component"
    Public CtrlMouseScroll As String = "Mouse Scroll Wheel - Zoom In/Out"
    Public StartTutorial As String = "Start Tutorial"
    Public SkipTutorial As String = "Skip Tutorial"
End Class