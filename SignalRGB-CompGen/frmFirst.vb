...
Public Class frmFirst
    ...
    Private Sub Translate()
        ...
        Text = loc.Language
        NsTheme1.Text = Text
        btnStart.Text = loc.StartTutorial
        btnSkip.Text = loc.SkipTutorial
    End Sub

    Private Sub Translate(id As String)
        Dim langDir = New DirectoryInfo("languages")
        Dim lang = New MyLanguage().Load($"{langDir.FullName}\{id}.json")

        Text = lang.Localization.Language
        NsTheme1.Text = Text
        btnStart.Text = lang.Localization.StartTutorial
        btnSkip.Text = lang.Localization.SkipTutorial
    End Sub
    ...
    Private Sub CreateLanguageButtons()
        Try
            ...
            For Each file In files
                ...
                End With
                AddHandler btn.Click, Sub() Translate(lang.LanguageID)
    ...
    Private Sub btnContinue_Click(sender As Object, e As EventArgs) Handles btnStart.Click
        Try
